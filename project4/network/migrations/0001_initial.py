# Generated by Django 4.0.5 on 2022-09-05 15:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('postID', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='postLiked', to='network.posts')),
                ('userID', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='liker', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Follows',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('postID', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='network.posts')),
                ('userID', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
